...
const Page = () => {
  ...
  return (
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16">
      ...
      <div className="relative h-[80vh] max-w-[850px] overflow-auto mt-4 border border-gray-400 scrollbar-hide rounded-lg">
        <table className="w-full text-sm text-gray-500 border-collapse">
          <thead className="bg-gray-50 text-gray-700 uppercase text-left">
            <tr>
              <th className="px-6 py-3 hidden sm:table-cell">Author name</th>
              <th className="px-6 py-3 hidden sm:table-cell">Blog title</th>
              <th className="px-6 py-3 hidden sm:table-cell">Date</th>
              <th className="px-6 py-3 hidden sm:table-cell">Action</th>
            </tr>
          </thead>
