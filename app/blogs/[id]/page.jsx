...
const page = ({params}) => {
  ...
  return ( 
    ...
    <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
      ...
      <button className=' cursor-pointer flex items-center font-medium py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000000] '>Get started <Image src={assets.arrow} alt=''/></button>
        </div>
